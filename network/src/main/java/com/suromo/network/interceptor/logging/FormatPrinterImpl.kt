package com.suromo.network.interceptor.logging

import android.text.TextUtils
import com.suromo.logger.MLog
import com.suromo.network.interceptor.LogInterceptor.Companion.isJson
import com.suromo.network.interceptor.LogInterceptor.Companion.isXml
import com.suromo.network.interceptor.logging.ResultFormatHandler.Companion.formatJson
import com.suromo.network.interceptor.logging.ResultFormatHandler.Companion.formatXml
 ...
 * desc   :
 */
class FormatPrinterImpl : IFormatPrinter {
    ...
    override fun printJsonResponse(
        ...
        bodyString =
            when {
                isJson(contentType) -> formatJson(bodyString!!)
                isXml(
                    contentType
                ) -> formatXml(bodyString)
                else -> bodyString
            }
        val responseBody =
            LINE_SEPARATOR + BODY_TAG + LINE_SEPARATOR + bodyString
