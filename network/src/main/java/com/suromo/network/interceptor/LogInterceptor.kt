...
import com.suromo.network.interceptor.logging.FormatPrinterImpl
import com.suromo.network.interceptor.logging.ResultFormatHandler.Companion.formatJson
import com.suromo.network.util.NetworkUtil
import com.suromo.network.util.ZipUtil.Companion.decompressForGzip
import com.suromo.network.util.ZipUtil.Companion.decompressToStringForZlib
import com.suromo.network.util.ZipUtil.Companion.hasUrlEncoded
import okhttp3.*
import okio.Buffer
...
class LogInterceptor : Interceptor {
    ...
    private val mPrinter: FormatPrinterImpl = FormatPrinterImpl()
